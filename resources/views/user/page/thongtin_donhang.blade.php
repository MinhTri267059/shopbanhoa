						...
						<div class="your-order">
							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											<img width="25%" src="user/assets/dest/images/shopping.png" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">Hoa Hướng Dương</p>
												<span class="color-gray your-order-info">Màu: Vàng</span>
												<span class="color-gray your-order-info">Loại: Giỏ</span>
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">120.000VND</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
